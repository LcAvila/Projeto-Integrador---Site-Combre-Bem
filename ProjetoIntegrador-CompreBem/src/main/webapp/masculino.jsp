...
<body>
				...
				<ul class="navbar-nav mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="feminino.jsp">Roupas
									Femininas</a></li>
							<li><a class="dropdown-item" href="masculino.jsp">Roupas
									Masculinas</a></li>
							<li><a class="dropdown-item" href="infantil.jsp">Roupas
									Infantis</a></li>
						</ul></li>
				</ul>
	...
	<div class="background"
		style="background-image: url(produto-img/background.jpg); background-repeat: no-repeat; background-size: cover; background-position: center top; width: 100%; max-width: 100%; height: 100vh;">
	...
	<div class="container_main">
		<main class="main_principal">
			...
			<div class="card mb-3" style="max-width: 18rem;">
				<img src="produto-img/roupa1.jpg" class="card-img-top"
					alt="Vestido Longo Sem Manga em Chiffon" id="card-1">
				<div class="card-body">
					<h5 class="card-title">THE NORTH FACE</h5>
					<p class="card-text">CASACO DESPORTIVO CORTA VENTO PRETO</p>
					<h6 class="card-subtitle mb-2 text-muted">R$ 150,00</h6>
					<button class="btn btn-warning btn-block">Comprar</button>
				</div>
			</div>
			<div class="card mb-3" style="max-width: 18rem;">
				<img src="produto-img/tren2.jpg" class="card-img-top"
					alt="Vestido Longo Sem Manga em Chiffon" id="card-2">
				<div class="card-body">
					<h5 class="card-title">PANGAIA</h5>
					<p class="card-text">PANGAIA BLACK 365 TRACK PANTS</p>
					<h6 class="card-subtitle mb-2 text-muted">R$ 80,00</h6>
					<button class="btn btn-warning btn-block">Comprar</button>
				</div>
			</div>
			<div class="card mb-3" style="max-width: 18rem;">
				<img src="produto-img/tren3.jpg" class="card-img-top"
					alt="Vestido Longo Sem Manga em Chiffon" id="card-3">
				<div class="card-body">
					<h5 class="card-title">HARMONY</h5>
					<p class="card-text">LOGO PRINTED SOLID COLOR HOODIE</p>
					<h6 class="card-subtitle mb-2 text-muted">R$ 280,00</h6>
					<button class="btn btn-warning btn-block">Comprar</button>
				</div>
			</div>
			<div class="card mb-3" style="max-width: 18rem;">
				<img src="produto-img/tren4.jpg" class="card-img-top"
					alt="Casaco Preto" id="card-4">
				<div class="card-body">
					<h5 class="card-title">HAZY EMERALD</h5>
					<p class="card-text">ADIDAS PHARRELL WILLIAMS BASIC PANTS (GÊNERO NEUTRO)</p>
					<h6 class="card-subtitle mb-2 text-muted">R$ 300,00</h6>
					<button class="btn btn-warning btn-block">Comprar</button>
				</div>
			</div>
	...
	<div class="Marcas">
		<img src="produto-img/brand1.png" alt="Marca"> <img
			src="produto-img/brand2.png" alt="Marca"> <img
			src="produto-img/brand3.png" alt="Marca"> <img
			src="produto-img/brand4.png" alt="Marca"> <img
			src="produto-img/brand5.png" alt="Marca"> <img
			src="produto-img/brand6.png" alt="Marca">
	</div>
	<!--Marcas-->
