...
<body>
	...
	<section class="max-width bg2" id="About">
		<div class="container">
			...
			<div class="down">
				<div class="box">
					<img src="produto-img/b1.png" alt="">
					<div class="text">
				...
				<div class="box">
					<img src="produto-img/b2.png" alt="">
					<div class="text">
						<h2 class="color-branco">Conjunto</h2>
						<p class="color-branco">Coleção de Inverno</p>
						<i class="fa fa-long-arrow-right"></i>
				...
				<div class="box">
					<img src="produto-img/b3.png" alt="">
					<div class="text">
						<h2 class="color-branco">Conjunto</h2>
						<p class="color-branco">Coleção de Inverno</p>
						<i class="fa fa-long-arrow-right"></i>
		...
		<div class="container">
			<div class="content">
				...
				<input type="radio" name="slider" id="item-1" checked> <input
					type="radio" name="slider" id="item-2"> <input type="radio"
					name="slider" id="item-3">
				<div class="cards">
					<label class="card" for="item-1" id="song-1"> <img
						src="produto-img/p1.jpg" alt="">
						<button>Comprar Agora</button>
					</label> <label class="card" for="item-2" id="song-2"> <img
						src="produto-img/p2.jpg">
						<button>Comprar Agora</button>
					</label> <label class="card" for="item-3" id="song-3"> <img
						src="produto-img/p3.jpg">
						<button>Comprar Agora</button>
					</label>
				</div>
			</div>
